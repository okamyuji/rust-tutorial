...
fn trait_object_dispatch() {
    ...
    println!("  HTML - キャッシュ可能: {}, キー: {}", 
             html.is_cacheable(), html.cache_key());
    println!("  Markdown - キャッシュ可能: {}, キー: {}", 
             markdown.is_cacheable(), markdown.cache_key());
    println!("  PlainText - キャッシュ可能: {}, キー: {}", 
             plain.is_cacheable(), plain.cache_key());
}
